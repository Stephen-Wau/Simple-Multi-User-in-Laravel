...
class FoodController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('admin/content/food/list',compact('food','request'));
    }
    ...
    public function add(){
        ...
        return view('admin/content/food/add');
    }
    ...
    public function store(Request $request){
        ...
        try {
            ...
            return redirect(route('admin.food.index'))->with('pesan-berhasil',
                'Anda berhasil menambah data food!');
        }catch (\Exception $e){
            ////pesan notifikasi tidak sukses
            return redirect(route('admin.food.index'))->with('pesan-gagal',
    ...
    public function edit($id){
        ...
        return view('admin/content/food/edit', compact('food'));
    }
