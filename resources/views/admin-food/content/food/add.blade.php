...
@section('content')
    ...
    <form method="post" action="{{route('admin-food.food.store')}}" enctype="multipart/form-data">
        @csrf
        ...
        <a href="{{route('admin-food.food.index')}}" class="btn btn-outline-info">Kembali</a>
