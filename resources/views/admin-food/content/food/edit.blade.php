...
@section('content')
    ...
    <form method="post" action="{{route('admin-food.food.update')}}">
        @csrf
        ...
        <a href="{{route('admin-food.food.index')}}" class="btn btn-outline-secondary"><i class="fa fa-arrow-left"> Batal</i></a>
