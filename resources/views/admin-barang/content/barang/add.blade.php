...
@section('content')
    ...
    <form method="post" action="{{route('admin-barang.barang.store')}}" enctype="multipart/form-data">
        @csrf
        ...
        <a href="{{route('admin-barang.barang.index')}}" class="btn btn-outline-info">Kembali</a>
